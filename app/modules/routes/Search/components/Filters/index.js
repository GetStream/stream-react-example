...
import { Tab, Tabs, Avatar } from 'components';
			...
			<Tabs className="tabs">
				<Tab key="filter-all" label="All">
					<div className="results">
						<ul>
							{this.renderResults(null, (r, i) => {
								switch (r.type) {
									case 'hashtags':
										return (
											<li
												key={`result-hashtags-${r.word}`}
												onClick={e =>
													this.props.onClick(e, i, r)}
											>
												<div className="result-inner">
													...
													<span>
														{numeral(r.count).format('0,0')}{' '}
														{r.count > 1 ? 'Photos' : 'Photo'}
													</span>
												</div>
											</li>
										);
