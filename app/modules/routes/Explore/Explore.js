		...
		return (
			<div className="page">
				...
				<div className="explore">
					<h1>Trending</h1>
					<div>
						<img src="//react-example-app.imgix.net/defaults/tumblr_ny9verGf7m1qzwmsso1_1280.jpg?auto=enhance&w=175&h=132&fit=crop&fm=png&dpr=2" />
					</div>
					<div>
						<img src="//react-example-app.imgix.net/defaults/tumblr_nxiqjsDFTK1qzwmsso1_1280.jpg?auto=enhance&w=124&h=95&fit=crop&fm=png&dpr=2" />
					</div>
					<div>
						<img src="//react-example-app.imgix.net/defaults/tumblr_nylyc2IsOi1qzwmsso1_1280.jpg?auto=enhance&w=174&h=132&fit=crop&fm=png&dpr=2" />
					</div>
				</div>
