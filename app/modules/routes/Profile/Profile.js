...
class Profile extends Component {
	...
	handleFollowProfile = () => {
		if (!this.props.profile.following) {
			this.props
				.dispatch(ProfileActions.follow(this.props.params.id))
				.then(res => {
			...
			this.props
				.dispatch(ProfileActions.unfollow(this.props.params.id))
				.then(res => {
					this.props.dispatch(PhotosActions.reload());
				});
		}
	...
	renderFollowingButton = () => {
		...
		return (
			<div
				...
				onClick={this.handleFollowProfile}
			>
				<i className={icon} />
				<Ink />
			</div>
					...
					<div className="artist">
						...
						<div className="name">
							...
							{this.props.profile.last_name &&
								this.props.profile.last_name.charAt(0) + '.'}
						</div>
