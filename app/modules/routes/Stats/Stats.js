...
import { Stats as StatsActions, Profile as ProfileActions } from 'actions';
		...
		return (
			<div>
				<Link to={`/photos/${this.props.id}`}>
					<div>
						<img
							src={`${config.imgix.baseUrl}/${this.props
								.filename}?auto=enhance&w=200&h=200&fit=crop&fm=png&dpr=2`}
							className="full-width"
						/>
					</div>
					<div className="footer-content">
						{this.props.caption} in{' '}
			...
			<div className="page">
				<div className="stats">
						...
						<div className="row">
							<div className="col">
								<div className="item">
									...
									<span
										className={
											this.props.stats.profileViews.color
										}
									>
										{
											this.props.stats.profileViews
												.increment
										}
									</span>
								</div>
								<div className="item">
									...
									<span
										className={
											this.props.stats.following.color
										}
									>
						...
						<div className="row">
							<div className="col">
								<div className="item">
									...
									<span
										className={
											this.props.stats.itemViews.color
										}
									>
								...
								<div className="item">
									...
									<span
										className={
											this.props.stats.followers.color
										}
									>
					...
					<div className="most most-views-from content">
						...
						<ol>
							{this.props.stats.geoViews.map(geo =>
								<li>
									{geo['ip_geo_info.city']},{' '}
									{geo['ip_geo_info.province']},{' '}
									{geo['ip_geo_info.country']}: {geo.result}
								</li>,
							)}
						</ol>
					</div>
					<div className="most most-views content">
						<h1>Most Views</h1>
						{this.props.stats.mostViewed.map(upload =>
							<UploadStats
